...
class RSA_:
   ...
   #   Read the keys on the proposed path.
    ...
    def encryptb64(self):
        ...
        self.encrypt_txt()
        message = self.b64_return('e',self.get_ciphertext())
        return message
    # set ciphertxt >> para funcionar >> retorna ciphertxt
    def decrypt64(self):

        self.set_ciphertext(self.b64_return('d',self.get_ciphertext()))
        self.decrypt_txt()
